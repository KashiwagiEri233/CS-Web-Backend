...
| 模块文档 | 系统级 → `tools/docs/BackDoc-Sec.md`/`tools/docs/BackDoc-Infra.md`；业务级 → `tools/docs/BackDoc-Mods.md` | 登记到 `tools/docs/README.md` 索引表；含「接口」节（见 `tools/docs/README.md` 的分类约定与模板） |
