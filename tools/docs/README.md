...
├── BackDoc-01-Arch.md     # 系统架构总览（分层/中间件链/生命周期/不变量）
...
| 文档 | 放什么内容 |
|---|---|
| `BackDoc-01-Arch.md` | 系统级架构：分层、中间件链、请求生命周期、关键不变量 |
...
| 文档 | 说明 |
|---|---|
| [BackDoc-01-Arch.md](BackDoc-01-Arch.md) | 系统架构总览（分层、目录结构、扩展配方） |
...
|---|---|---|
## 提交前检查清单
- [ ] 新增/修改 API 端点 → 对应文档（`BackDoc-02-Sec.md`/`BackDoc-Infra.md`/`BackDoc-Mods.md`）接口表已更新
