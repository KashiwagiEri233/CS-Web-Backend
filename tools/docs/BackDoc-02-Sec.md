...
> 关联：架构见 [BackDoc-01-Arch.md](BackDoc-01-Arch.md)；基础设施见 [BackDoc-Infra.md](BackDoc-Infra.md)；编码规范见 [BackDoc-03-Conv.md](BackDoc-03-Conv.md)；前端 BFF 层安全与 UI 路由保护见 [FrontDoc-02-Sec.md](../../../CS-Web-Frontend/tools/docs/FrontDoc-02-Sec.md)
...
- **`LLM_DAILY_BUDGET` 预算强制接入待确认**（汇入 `docs/项目待办v2.md` W-2）。
