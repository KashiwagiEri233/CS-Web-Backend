...
DEFAULT_PERMISSIONS: List[Dict[str, str]] = [
    ...
    {
        "name": "community:category_create",
        "resource": "community",
        "action": "category_create",
        "description": "创建版块",
    },
    {
        "name": "community:category_update",
        "resource": "community",
        "action": "category_update",
        "description": "编辑版块",
    },
    {
        "name": "community:category_delete",
        "resource": "community",
...
def build_default_roles(all_permission_keys: List[str]) -> List[Dict[str, Any]]:
    ...
    return [
        ...
        # 细粒度角色（前后端分离迁移 Phase 2 预建；权限随对应模块迁移补充）
        {
            ...
            "description": "内容审核员；社区审核权限随 Phase 4 迁移补充",
            "is_system": True,
            "permissions": [
                "community:read",
                "community:update",
